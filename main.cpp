...
int main() {
   ...
   std::cout << "GetValue(A1): " << sheet->GetCell("A1"_pos)->GetValue() << std::endl;
    ...
    //std::cout << "GetValue(C3): " << sheet->GetCell("C3"_pos)->GetValue() << std::endl;
    //std::cout << "GetPrintableSize(): " << sheet->GetPrintableSize() << std::endl;
    //std::cout << "PrintTexts(): " << std::endl;
    //sheet->PrintTexts(std::cout);
    //std::cout << "PrintValues(): " << std::endl;
    //sheet->PrintValues(std::cout);

    //std::cout << "After Clear A1" << std::endl;
    //sheet->ClearCell("A1"_pos);

    //std::cout << "GetCell(A1)==nullptr: " << std::boolalpha << (sheet->GetCell("A1"_pos) == nullptr) << std::endl;
    //std::cout << "GetCell(B2)==nullptr: " << std::boolalpha << (sheet->GetCell("B2"_pos) == nullptr) << std::endl;
    //std::cout << "GetCell(C3)==nullptr: " << std::boolalpha << (sheet->GetCell("C3"_pos) == nullptr) << std::endl;
    //std::cout << "GetPrintableSize(): " << sheet->GetPrintableSize() << std::endl;
    //std::cout << "PrintTexts(): " << std::endl;
    //sheet->PrintTexts(std::cout);
    //std::cout << "PrintValues(): " << std::endl;
